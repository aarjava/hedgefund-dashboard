...
with st.sidebar:
    ...
    vol_q_high = st.slider(
        ...
        help="Threshold for 'High Volatility'. 0.80 means the top 20% of most volatile days are classified as High Volatility regime."
    )
    ...
    bt_cost = st.number_input(
        ...
        step=1,
        help="Basis points (bps) represent 1/100th of 1%. Example: 10 bps = 0.10% cost per trade."
    ) / 10000
