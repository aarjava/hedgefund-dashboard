...
with st.sidebar:
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="Threshold to define 'High Volatility'. 0.75 means the top 25% of most volatile days.",
    )
    ...
    bt_cost = (
        st.number_input(
            ...
            step=1,
            help="Simulated trading cost per transaction (e.g., commission + slippage). 10 bps = 0.10%.",
        )
        / 10000
    )
