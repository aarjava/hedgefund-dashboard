...
with st.sidebar:
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="The threshold to classify market volatility as 'High'. E.g., 0.80 means the top 20% most volatile days are considered 'High Volatility'.",
    )
    ...
    bt_cost = (
        st.number_input(
            ...
            step=1,
            help="Execution cost per trade in basis points. 10 bps = 0.10%. Typical retail costs are ~0-10 bps.",
        )
        / 10000
    )
