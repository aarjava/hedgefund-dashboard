...
with st.sidebar:
    ...
    if mode == "Single-Asset":
        ...
        adv_pct = st.slider(
            ...
            0.01,
            help="Percentage of Average Daily Volume used to estimate liquidity impact.",
        )
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="Defines the threshold for 'High Volatility'. A value of 0.8 means the top 20% of trading days by volatility are classified as 'High Volatility'.",
    )
    ...
    if mode == "Single-Asset":
        ...
        bt_cost = (
            st.number_input(
                ...
                step=1,
                help="Slippage and commission per trade. 10 bps = 0.10%.",
            )
            / 10000
        )
