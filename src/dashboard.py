...
with st.sidebar:
    ...
    if mode == "Single-Asset":
        ...
        adv_pct = st.slider(
            ...
            0.01,
            help="Limit trade size to this % of Average Daily Volume to simulate liquidity constraints.",
        )
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="Threshold for 'High Volatility'. E.g., 0.80 means the top 20% most volatile days are classified as High Vol.",
    )
