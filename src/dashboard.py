...
with st.sidebar:
    ...
    bt_cost = (
        st.number_input(
            ...
            step=1,
            help="Simulates execution drag. Example: 10 bps = 0.10% per trade.",
        )
        / 10000
    )
    allow_short = st.checkbox(
        "Allow Short Selling?",
        value=False,
        help="If checked, the strategy will short sell (bet against) the asset when the trend is negative.",
    )
