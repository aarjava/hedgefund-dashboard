...
with st.sidebar:
    ...
    vol_q_high = st.slider(
        ...
        help="Defines the threshold for 'High Volatility'. E.g., 0.80 means the top 20% of most volatile days."
    )
    ...
    bt_cost = st.number_input(
        ...
        step=1,
        help="Cost per trade in basis points. E.g., 10 bps = 0.10% slippage + commission."
    ) / 10000
