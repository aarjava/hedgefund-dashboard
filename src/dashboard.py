...
with st.sidebar:
    ...
    if mode == "Single-Asset":
        ...
        weights_input = st.text_input(
            ...
            help="Example: 0.5, 0.3, 0.2. If left blank, equal weights will be applied.",
        )
    ...
    if mode == "Single-Asset":
        ...
        adv_pct = st.slider(
            ...
            0.01,
            help="Percentage of Average Daily Volume to limit trade size. 0.10 means 10% of ADV.",
        )
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="Defines the threshold for High Volatility regime. E.g., 0.80 means the top 20% of volatility days are considered 'High Vol'.",
    )
    ...
    if mode == "Single-Asset":
        ...
        bt_cost = (
            st.number_input(
                ...
                step=1,
                help="Basis points per trade. 10 bps = 0.10%. Simulates execution slippage and commissions.",
            )
            / 10000
        )
        ...
        vol_alert = st.slider(
            ...
            0.35,
            0.05,
            help="Annualized volatility threshold for alerts. 0.35 means 35% annualized volatility.",
        )
