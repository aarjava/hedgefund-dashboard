...
with st.sidebar:
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="Threshold to define 'High Volatility'. 0.95 means the top 5% of volatility days are classified as High Regimes.",
    )
    ...
    bt_cost = (
        st.number_input(
            ...
            step=1,
            help="Cost per trade in basis points (bps). 10 bps = 0.10%. Accounts for spread and commissions.",
        )
        / 10000
    )
