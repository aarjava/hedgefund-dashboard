...
with st.sidebar:
    ...
    if mode == "Single-Asset":
        ...
        factor_window = st.slider(
            ...
            63,
            7,
            help="Rolling window to compute factor betas (e.g., 63 days = 3 months)",
        )
        vol_window = st.slider(
            ...
            21,
            5,
            help="Rolling window to compute volatility regimes (e.g., 21 days = 1 month)",
        )
        adv_pct = st.slider(
            "ADV Participation %",
            0.01,
            ...
            0.01,
            help="Expected participation rate in Average Daily Volume (e.g., 0.10 = 10%)",
        )
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="Quantile to define the High Volatility regime (e.g., 0.75 = 75th percentile)",
    )
