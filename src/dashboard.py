...
with st.sidebar:
    ...
    if mode == "Single-Asset":
        ...
        adv_pct = st.slider(
            ...
            0.01,
            help="Percentage of Average Daily Volume to assume as liquidity limit.",
        )
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="Defines the threshold for 'High Volatility'. E.g., 0.75 means the top 25% of most volatile days are classified as High Vol.",
    )
    ...
    if mode == "Single-Asset":
        ...
        bt_cost = (
            st.number_input(
                ...
                step=1,
                help="1 basis point = 0.01%. 10 bps = 0.10% transaction cost.",
            )
            / 10000
        )
