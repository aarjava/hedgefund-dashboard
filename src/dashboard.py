...
with st.sidebar:
    ...
    if mode == "Single-Asset":
        ...
        factor_window = st.slider(
            ...
            63,
            7,
            help="Lookback days for factor beta calculation. e.g., 63 days = 3 months.",
        )
        vol_window = st.slider(
            ...
            21,
            5,
            help="Lookback days for volatility calculation. e.g., 21 days = 1 month.",
        )
        adv_pct = st.slider(
            "ADV Participation %",
            0.01,
            ...
            0.01,
            help="Assumed participation rate in Average Daily Volume. e.g., 0.10 = 10% of ADV.",
        )
    ...
    if mode == "Single-Asset":
        ...
        dd_alert = st.slider(
            ...
            -0.2,
            0.05,
            help="Maximum drawdown threshold for alert triggering. e.g., -0.2 = -20% drawdown.",
        )
        vol_alert = st.slider(
            ...
            0.35,
            0.05,
            help="Annualized volatility threshold for alert triggering. e.g., 0.35 = 35% annualized volatility.",
        )
        beta_alert = st.slider(
            ...
            1.3,
            0.1,
            help="Portfolio beta threshold for alert triggering. e.g., 1.3 = 30% more volatile than benchmark.",
        )
        dttl_alert = st.slider(
            ...
            5.0,
            1.0,
            help="Days to liquidate threshold for alert triggering. e.g., 5.0 = 5 days to liquidate position.",
        )
