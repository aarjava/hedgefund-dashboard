...
with st.sidebar:
    ...
    if mode == "Single-Asset":
        ...
        portfolio_value = st.number_input(
            ...
            step=100000.0,
            help="Total starting value. e.g. 1000000 = $1,000,000",
        )
    ...
    if mode == "Single-Asset":
        ...
        factor_window = st.slider(
            ...
            63,
            7,
            help="Rolling window for beta calculations. e.g. 63 days ≈ 3 months.",
        )
        ...
        adv_pct = st.slider(
            ...
            0.01,
            help="Max percentage of Average Daily Volume allowed to trade. e.g. 0.10 = 10% limit.",
        )
    ...
    vol_q_high = st.slider(
        ...
        DEFAULT_VOL_QUANTILE_HIGH,
        0.05,
        help="Threshold for classifying high vol regime. e.g. 0.75 means volatility must exceed the 75th percentile of historical data.",
    )
    ...
    if mode == "Single-Asset":
        ...
        bt_cost = (
            st.number_input(
                ...
                step=1,
                help="Round-trip transaction costs in basis points. e.g. 10 bps = 0.10%",
            )
            / 10000
        )
        ...
        dd_alert = st.slider(
            ...
            -0.2,
            0.05,
            help="Drawdown threshold to trigger alert. e.g. -0.20 = 20% drop from peak.",
        )
        vol_alert = st.slider(
            ...
            0.35,
            0.05,
            help="Annualized volatility threshold to trigger alert. e.g. 0.35 = 35% annualized.",
        )
        beta_alert = st.slider(
            ...
            1.3,
            0.1,
            help="Portfolio beta against benchmark threshold. e.g. 1.3 = 30% more volatile than benchmark.",
        )
        dttl_alert = st.slider(
            ...
            5.0,
            1.0,
            help="Liquidity stress alert. e.g. 5.0 = takes 5 days to liquidate position based on ADV constraints.",
        )
